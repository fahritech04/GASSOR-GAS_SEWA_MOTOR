...
<div class="pdf-container">
    ...
    <div class="pdf-summary">
        <div><strong>Total Pendapatan (sebelum PPN):</strong> Rp {{ number_format($summary['total_income'] / 1.11, 0, ',', '.') }}</div>
        <div><strong>Total Transaksi:</strong> {{ $summary['total_transactions'] }}</div>
        <div><strong>Pendapatan Rata-rata (sebelum PPN):</strong> Rp {{ number_format($summary['average_income'] / 1.11, 0, ',', '.') }}</div>
    </div>
</div>
</body>
</html>
