...
@section('content')
    <div id="Content-Container" class="relative flex flex-col w-full max-w-[640px] min-h-screen mx-auto bg-white overflow-x-hidden">
        ...
        <div class="form-row">
            <div class="form-col">
            <label for="email" class="text-sm font-medium">Tempat Lahir</label>
            ...
            <div class="form-col">
            <label for="phone" class="text-sm font-medium">Tanggal lahir</label>
            <input type="date" id="phone" placeholder="Enter your phone number" class="w-full p-4 rounded-full bg-[#F5F6F8] border-none outline-none focus:outline-none focus:ring-0 focus:border-none focus:shadow-none" />
            </div>
        </div>
